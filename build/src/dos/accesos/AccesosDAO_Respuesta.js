    ...
    static procesar(registro, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (registro != null) {
                ...
                const miToken = jsonwebtoken_1.default.sign({ Nombre: registro.nombreUsaurio, Apellido: registro.apellidoUsuario, role: registro.nombreRol, dosDev: 'eso somos' }, 'LaClaveVaAqui', { expiresIn: '8h' });
